...
namespace WMR100.NET.Tests
{
    ...
    public class Wmr100DataFrameTests
    {
        ...
        {
            Assert.That(expectedResult, Is.EqualTo(new Wmr100DataFrame(ByteArrayUtils.StringToByteArray(frame)).IsChecksumValid()));
        }
        ...
        {
            Assert.That(expectedResult, Is.EqualTo(new Wmr100DataFrame(ByteArrayUtils.StringToByteArray(frame)).IsLengthValid()));
        }
        ...
        {
            Assert.That(ByteArrayUtils.StringToByteArray(packet), Is.EqualTo(new Wmr100DataFrame(ByteArrayUtils.StringToByteArray(frame)).GetPacketData()));
        }
    }
}
